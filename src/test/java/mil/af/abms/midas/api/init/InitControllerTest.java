...
public class InitControllerTest extends ControllerTestHarness {
    ...
    public void should_get_from_public_info() throws Exception {
        ...
        mockMvc.perform(get("/init"))
                ...
                .andExpect(jsonPath("$.productJourneyMap").isArray())
                .andExpect(jsonPath("$.productJourneyMap[*].name").isNotEmpty())
                .andExpect(jsonPath("$.productJourneyMap[*].offset").isNotEmpty())
                .andExpect(jsonPath("$.productJourneyMap[*].description").isNotEmpty())
