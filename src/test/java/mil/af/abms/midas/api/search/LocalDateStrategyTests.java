...
class LocalDateStrategyTests extends RepositoryTestHarness {

    private static final LocalDate START_OCTOBER = LocalDate.of(2021, 10, 10);
    private static final LocalDate START_NOVEMBER = LocalDate.of(2021, 11, 10);
    ...
    void should_search_by_spec_and_parsing_strategy_status_equal_to() {
        SearchCriteria criteria = new SearchCriteria("startDate", ":", null, "2021-10-10", null);
    ...
    void should_return_dates_less_than() {
        SearchCriteria criteria = new SearchCriteria("startDate", "<", null, "2021-11-10", null);
        Specification<Assertion> specs = new SpecificationImpl<>(criteria);
        List<Assertion> assertions = assertionRepository.findAll(specs);
