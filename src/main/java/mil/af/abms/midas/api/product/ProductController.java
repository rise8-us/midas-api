...
public class ProductController extends AbstractCRUDController<Product, ProductDTO, ProductService> {
    ...
    public List<SprintProductMetricsDTO> getSprintMetrics(@PathVariable Long id, @PathVariable String startDate, @RequestParam(defaultValue = "14") Integer duration, @RequestParam(defaultValue = "10") Integer sprints) {
