...
public class PortfolioController extends AbstractCRUDController<Portfolio, PortfolioDTO, PortfolioService> {
    ...
    public HashMap<Long, List<SprintProductMetricsDTO>> getSprintMetrics(@PathVariable Long id, @PathVariable String startDate, @RequestParam(defaultValue = "14") Integer duration, @RequestParam(defaultValue = "10") Integer sprints) {
